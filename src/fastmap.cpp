...
{
    fprintf(stderr, "Usage: bwa-plus mem [options] <idxbase> <in1.fq> [in2.fq]\n");
...
int main_mem(int argc, char *argv[])
{
    ...
    if (mode)
    {
        fprintf(stderr, "WARNING: bwa doesn't work well with long reads or contigs; please use minimap2 instead.\n");
